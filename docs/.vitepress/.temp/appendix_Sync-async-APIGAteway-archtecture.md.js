...
const __pageData = JSON.parse('{"title":"同期・非同期アーキテクチャ図（API Gateway 付き）","description":"","frontmatter":{},"headers":[],"relativePath":"appendix/Sync-async-APIGAteway-archtecture.md","filePath":"appendix/Sync-async-APIGAteway-archtecture.md"}');
const _sfc_main = { name: "appendix/Sync-async-APIGAteway-archtecture.md" };
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  _push(`<div${ssrRenderAttrs(_attrs)}><h1 id="同期・非同期アーキテクチャ図-api-gateway-付き" tabindex="-1">同期・非同期アーキテクチャ図（API Gateway 付き） <a class="header-anchor" href="#同期・非同期アーキテクチャ図-api-gateway-付き" aria-label="Permalink to &quot;同期・非同期アーキテクチャ図（API Gateway 付き）&quot;">​</a></h1><blockquote><p>図は Mermaid を <strong><code>&lt;pre class=&quot;mermaid&quot; v-pre&gt;</code></strong> で描画します。</p></blockquote><pre class="mermaid">flowchart TD
%% ============== Subgraphs =========================
subgraph users[&quot;ユーザー&quot;]
  Client[&quot;クライアント／ブラウザ&quot;]
end
