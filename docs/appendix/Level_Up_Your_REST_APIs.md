...
1. **エラー形式（p05）** を統一（最短で効果が出る）
2. 一覧APIに **ページング（p07）** と **フィルタ/ソート（p08）**
3. 更新・作成系に **Idempotency/ETag（p09/p10）**
4. 公開/社内展開に合わせて **429（p11）** と **OpenAPI（p14）**
5. 最後に **version/deprecation（p13）** を運用設計として固める
