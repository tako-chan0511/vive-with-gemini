...
設計やレビューを一緒に考えてくれる **ペアプロ（ワーク）の相棒** として扱えるチームをめざしています。

![ペアプロ](./public/images/vive/ペアプロ.jpg)

図のように、自分のまわりに複数の AI「相棒」がいて、  
ひたすら壁打ち（会話）を繰り返すイメージです。  
**この壁打ちの回数が、そのまま得られるフィードバック量＝価値に比例する**、  
という感覚をチーム全体で大事にしています。

もし AI をそのようなパートナーとして迎え入れることができれば、  
チームの議論はもっと **会話中心のプロセス** に近づいていくはずだ──  
そんな仮説から、この取り組みを始めました。
...
![AI活用アジャイルチーム](./public/images/vive/Agile-AI-PO.jpg)
...
![ROI最大化](./public/images/vive/ROI最大化.jpg)

上の図のように、ステークホルダとアジャイルチームの間に立つ PO が、  
