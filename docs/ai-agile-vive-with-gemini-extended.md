...
この実践の狙いは、AIにコードを書かせることではなく、ROI最大化を実現することにあります。ROI最大化とは、Value（価値提供）を高めながらCost（自働化・効率化）を下げることです。再春館システム様で進めたAI活用では、設計・実装・テストの各フェーズでAIと対話し、フィードバックを短いサイクルで回すことで、結果としてアジャイル／SCRUMな振る舞いが自然に生まれました。AIは、その両輪を支える最大の相棒だったのです。
...
![「AI+自働化」による開発ループ短縮の取り組み](./public/images/vive/「AI+自働化」による開発ループ短縮の取り組み.jpg)



その前提として意識ているのが、**AIは確率の世界で「もっともらしい答え」を返す存在**だという点です。  
...
![アジャイル開発とフィードバックループによるROI最大化](./public/images/vive/アジャイル開発とフィードバックループによるROI最大化.jpg)
...
![アジャイルに変えてからのVelocityの変化](./public/images/vive/アジャイルに変えてからのVelocityの変化.jpg)
