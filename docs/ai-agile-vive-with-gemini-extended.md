...
AIはもともと「統計的にもっともらしい答え」を返す仕組みなので、  
発想を広げたいとき（アイデア出し・例のバリエーション出し など）は、  
あえて自由度高め・抽象度高めに使うのが向いています。  

一方で、今回のように**品質や生産性をしっかり高めたい場面**では、  
抽象的な指示よりも、アーキテクチャ設計やフレームワーク、命名規則など  
“枠組みが明確な領域”をきちんと用意し、その中で動いてもらうほうが安定します。  

このため、AIを活用する際は、  
「アイデア拡散モード」と「品質・生産性向上モード」を意識して使い分け、  
後者ではあえて自由にさせすぎないことが、結果的に品質を高めるポイントだと感じています。
